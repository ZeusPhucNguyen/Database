...
GO
 INSERT INTO TOYS VALUES 
						 ('TE025',' Sword Shield 5','CARD','POKEMON COMPANY','6-12',30,325,85),
						 ('TW325',' Timeless Trends Kitchen','KITCHEN','STEP COMPANY','3-12',125,1200,56),
						 ('XR025','Kid Juinor Doctor','DOCTOR','STEP COMPANY','3-12',66,400,38),
						 ('MT125','CAR RACING','RACING CONTROLLER','LEGO COMPANY','3-12',25,400,96),
						 ('RT325','UNO','CARD ','ABC COMPANY','6-18',6,350,80),
						 ('TA012','Barbie Fashionistas Doll','Doll','ABC COMPANY','3-9',10,125,50),
						 ('AM032','TEDDY BEAR','STUFFED ANIMAL','TOY COMPANY','2-12',600,356,120),
						 ('RF025','LEGO','LEGO','LEGO COMPANY','3-12',65,362,80),
						 ...
						 ('PL632','Barbie Fashionistas','Doll','ABC COMPANY','3-9',15,156,140),
